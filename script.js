...
cash += Math.floor((secondsAway * ((twoown * twoper)/2)) * autotwo);
cash += Math.floor((secondsAway * ((threeown * threeper)/3)) * autothree);
cash += Math.floor((secondsAway * ((fourown * fourper)/4)) * autofour);
cash += Math.floor((secondsAway * ((fiveown * fiveper)/5)) * autofive);
cash += Math.floor((secondsAway * ((sixown * sixper)/6)) * autosix);
cash += Math.floor((secondsAway * ((sevenown * sevenper)/7)) * autoseven);
cash += Math.floor((secondsAway * ((eightown * eightper)/8)) * autoeight);
cash += Math.floor((secondsAway * ((nineown * nineper)/9)) * autonine);
cash += Math.floor((secondsAway * ((tenown * tenper)/10)) * autoten);
localStorage.setItem("cash", cash);
